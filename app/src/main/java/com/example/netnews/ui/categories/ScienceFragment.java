...
import com.example.netnews.databinding.FragmentScienceBinding;
...
public class ScienceFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        handler.postDelayed(delayedRunnable,8000);


    }

    private void getScienceNews() {
        newsViewModel.getSectionNews("SCIENCE").observe(getViewLifecycleOwner(), new Observer<List<Data>>() {
            @Override
    ...
    private void displayScienceNews() {
        scienceRV = binding.scienceRecyclerView;
